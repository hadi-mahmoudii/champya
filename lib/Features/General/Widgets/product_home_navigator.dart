import 'package:champya/Features/Product/Models/product.dart';
import 'package:flutter/material.dart';

import '../../../Core/Config/routes.dart';

class ProductHomeNavigator extends StatelessWidget {
  final BoxConstraints cons;
  final int index;
  final ProductModel program;
  const ProductHomeNavigator({
    Key? key,
    required this.cons,
    required this.index,
